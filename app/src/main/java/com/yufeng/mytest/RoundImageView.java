...
public class RoundImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable instanceof TransitionDrawable) {
            TransitionDrawable t = (TransitionDrawable) drawable;
            int index = t.getNumberOfLayers() - 1;
            if (index >= 0) {
                Drawable drawable2 = t.getDrawable(index);
                if (drawable2 != null && drawable2 instanceof BitmapDrawable) {
                    b = ((BitmapDrawable) drawable2).getBitmap();
                } else {
        ...
        if (mBorderInsideColor != defaultColor
            ...
            radius = ((defaultWidth < defaultHeight ? defaultWidth : defaultHeight) - (getPaddingLeft() + getPaddingRight())) / 2;
        }
        if (bitmap != null) {
